...
public class PasswordResetOtpService : IPasswordResetOtpService
{
    ...
    public void StoreOtp(string userId, string otp, TimeSpan expiry)
    {
        ...
        _logger.LogInformation("Stored password reset OTP for user {UserId}, Key: {Key}, Expiry: {Minutes}min, SuccessfullyRetrieved: {Retrieved}",
    ...
    public bool ValidateAndConsumeOtp(string userId, string otp)
    {
        ...
        _logger.LogInformation("OTP Validation attempt - UserId: {UserId}, Key: {Key}, Exists: {Exists}",
