...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<ProFighter.Application.Common.Interfaces.ISubscriptionUpsertService, ProFighter.Application.Subscriptions.Services.SubscriptionUpsertService>();
        services.AddScoped<ProFighter.Application.Subscriptions.Jobs.SyncCustomerSubscriptionsJob>();
